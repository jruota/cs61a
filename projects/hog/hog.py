...
def boar_brawl(player_score, opponent_score):
    ...
    difference = abs(opponent_digit - player_digit)
    return max(1, 3 * difference)
    # END PROBLEM 2
...
def sus_points(score):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    no_of_factors = num_factors(score)
    if (no_of_factors == 3 or no_of_factors == 4):
        score += 1
...
def play(strategy0, strategy1, update,
    ...
    while (score0 < goal and score1 < goal):
        if (who == 0):
            no_of_rolls = strategy0(score0, score1)
            score0 = update(no_of_rolls, score0, score1, dice)
        else:
            no_of_rolls = strategy1(score1, score0)
            score1 = update(no_of_rolls, score1, score0, dice)
        who = 1 - who
    # END PROBLEM 5
...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    # BEGIN PROBLEM 9
    "*** YOUR CODE HERE ***"
    i, max_scoring_rolls, max_score = 1, 0, 0
    while (i <= 10):
...
def final_strategy(score, opponent_score):
    ...
    *** YOUR DESCRIPTION HERE ***
    """
    # BEGIN PROBLEM 12
    return boar_strategy(
        score,
        opponent_score,
        threshold=sus_update(6, score, opponent_score))
    # END PROBLEM 12
